...
def generate_by_rule(
    ...
    *,
    ...
    try:
        vars = gen(
            original, per_rule_count, miner_salt=miner_salt, batch_salt=batch_salt
        )
...
def generate_all_rules(
    ...
    *,
    ...
    return generate_for_rules(
        original,
        list(RULE_GENERATORS.keys()),
        per_rule_count,
        total_limit,
        miner_salt=miner_salt,
        batch_salt=batch_salt,
